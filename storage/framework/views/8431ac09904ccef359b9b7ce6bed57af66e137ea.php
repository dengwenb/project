...
<link href="/static/css/tq1style.css" rel="stylesheet" type="text/css">
            ...
            <div class="top-cart-contain">
              <div class="mini-cart">
                <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle"> <a href="#">
                  ...
                  <div class="shoppingcart-inner hidden-xs"><span class="cart-title">购物车</span> <span class="cart-total" style="color:red"> <?php echo e(count(session('cart'))); ?> 件</span><span class="attpri" style="position:relative;top:-45px;left:50px"></span></div>
                  </a></div>
                <div>
                  <div class="top-cart-content">
                    ...
                    <ul id="cart-sidebar" class="mini-products-list">
                      <?php if($ortotal = 0): ?>  <?php endif; ?>
                      <?php if(!empty(session('cart'))): ?>
                      <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li class="item odd"> <a href="/homeCart" title="Ipsums Dolors Untra" class="product-image"><img src="<?php echo e($value['pic']); ?>" alt="Lorem ipsum dolor" width="65"></a>
                        <div class="product-details"> <a href="javascript:;"  onClick="mydel(this,<?php echo e($value['distant']); ?>,<?php echo e($value['sid']); ?>)"  title="Remove This Item" class="remove-cart"><i class="icon-close"></i></a>
                          <p class="product-name"><a href="shopping_cart.html">商品</a></p>
                          <strong class="strnum"><?php echo e($value['num']); ?></strong> x <span class="price">$<?php echo e($value['price']); ?></span> </div>
                        
                        <input type="hidden" name="totalaaa" value="<?php echo e($ortotal +=$value['num']*$value['price']); ?>">
                      </li>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     <?php endif; ?>
                    </ul>

                    <div class="top-subtotal">总价: <span class="price attpri">$<?php echo e(isset($ortotal) ? $ortotal : 0); ?></span></div>
                    <div class="actions">
...
<script type="text/javascript">
  ...
  $('span.attpri').html('$'+<?php echo e(isset($ortotal) ? $ortotal : 0); ?>);
</script>
<!-- <script>
