    ...
    <div class="container">
      ...
      <div class="col-main col-sm-9 col-xs-12">
          ...
          <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
            ...
            <div class="large-image"> <a href="<?php echo e(substr($data[0]->path,1)); ?>" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img class="zoom-img" src="<?php echo e(substr($data[0]->path,1)); ?>" alt="products"> </a> </div>
            <div class="flexslider flexslider-thumb">
              <ul class="previews-list slides">
                ...
                <li><a href='<?php echo e(substr($row->path,1)); ?>' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '<?php echo e(substr($row->path,1)); ?>' "><img src="<?php echo e(substr($row->path,1)); ?>" alt = "Thumbnail 2"/></a></li>
          ...
          <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 product-details-area">
              ...
              <div class="product-name">
                <h1><?php echo e($data[0]->name); ?></h1>
              </div>
              <div class="price-box">
                <p class="special-price"> <span class="price-label">Special Price</span> <span class="price"> $<?php echo e($data[0]->price); ?> </span> </p>
                <p class="old-price"> <span class="price-label">Regular Price:</span> <span class="price"> $<?php echo e($data[0]->price+20); ?> </span> </p>
              </div>
              <div class="ratings">
              ...
              <div class="short-description">
                <h2>商品 概述</h2>
                <p><?php echo e($data[0]->descr); ?>

                <p></p>       
              </div>
              <div class="product-color-size-area">
                <?php $__currentLoopData = $num; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="size-area">
                  <h2 class="saider-bar-title"><?php echo e($row->name); ?></h2>
                  <div class="size">
                    <ul>
                      <?php $__currentLoopData = $attr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($row->attid == $r->attid): ?>
                     <li><a href="javascript:;" style="width:100%"><label for="<?php echo e($r->vid); ?>" class="att" style="width:100%" name="<?php echo e($row->name); ?>"><?php echo e($r->vname); ?></label></a></li>
                      <input type="radio" name="skuattr[<?php echo e($r->attid); ?>]" value="<?php echo e($r->vid); ?>" id="<?php echo e($r->vid); ?>"     hhh="<?php echo e($row->name); ?>"  ttt="<?php echo e($r->attid); ?>"    form="tjcart" style="display:none">   
                        <?php endif; ?>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                  </div>
              ...
              <div class="product-variation">
                <form action="/homeCart" method="post" id="tjcart">
                  ...
                  <input type="hidden" name="sid" value="<?php echo e($data[0]->id); ?>">
                  <input type="hidden" name="price" value="0">
                  <input type="hidden" name="pic" value="<?php echo e(substr($data[0]->path,1)); ?>">
         ...
         <aside class="right sidebar col-sm-3 col-xs-12">
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              <ul>
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.html" title="Sample Product" class="product-image"><img src="<?php echo e(substr($data[0]->path,1)); ?>" alt="Sample Product "></a></div>
                  ...
                  <div id="related-product-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col4 fadeInUp">
                      ...
                      <div class="product-item">
                        <div class="item-inner fadeInUp">
                          <div class="product-thumbnail">
                            <div class="pr-img-area"> <img class="first-img" src="<?php echo e(substr($data[0]->path,1)); ?>" alt=""> <img class="hover-img" src="<?php echo e(substr($data[0]->path,1)); ?>" alt="">
                          ...
                          <div class="item-info">
                            <div class="info-inner">
                              <div class="item-title"> <a title="Ipsums Dolors Untra" href="single_product.html"><?php echo e($data[0]->name); ?></a> </div>
                              <div class="item-content">
                                <div class="rating"> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> </div>
                                <div class="item-price">
                                  <div class="price-box">
                ...
                $('.size>ul').last().find('input[type="radio"]').click(function(){
                  ...
                  newarr = '['+newarr+']';
                         $.ajax({
                              type: 'GET',
                              url: '/homeCartprice',
                              data: {skuattr:newarr,id:<?php echo e($data[0]->id); ?>},
                              dataType: 'json',
...
<?php $__env->startSection('title','商品页'); ?>
