...
<article class="page-container">
	<form action="/adminSku" method="post" class="form form-horizontal" id="form-member-add" >
		...
		<div class="row cl">
			...
			<?php else: ?>
			<input type="hidden" name="sid" value="<?php echo e($_GET['sid']); ?>">
			<div class="row cl">
			<label class="form-label col-xs-1 col-sm-1">组合属性：</label>
				<?php $__currentLoopData = $num; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="formControls col-xs-2 col-sm-2"> <span class="select-box">
					<?php echo e($val->name); ?>

				<select class="select" size="1" id="relation" name="manyattr[<?php echo e($val->attid); ?>]">				
					<option value="" >--选择器--</option>
						<?php $__currentLoopData = $attval; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php if($value->pid==$val->attid): ?>
						<option value="<?php echo e($value->vid); ?>">规格:商品的<?php echo e($value->aname); ?>:<?php echo e($value->vname); ?></option>	
						<?php endif; ?>
...
<?php $__env->startSection('title','添加库存'); ?>
