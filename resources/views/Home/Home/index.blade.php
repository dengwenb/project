      ...
      <div class="tp-banner" >
        <ul>
          ...
          <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" > 
            <!-- 底层图片 --> 
            <img src="static/home/images/slider/slider-img1.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat"> 
            <!-- 动态 --> 
            <!-- LAYER NR. 1 -->
          ...
          <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" > 
            <!-- MAIN IMAGE --> 
            <img src="static/home/images/slider/slider-img2.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
            <!-- LAYER NR. 1 -->
          ...
          <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" > 
            <!-- MAIN IMAGE --> 
            <img src="static/home/images/slider/slider-img3.jpg" alt="slidebg3" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
            <!-- LAYER NR. 1 -->
                        ...
                        <div class="product-item">
                          <div class="item-inner">
                            ...
                            <!-- 图片标注 -->
                              ...
                              <!-- 特效 -->
                              <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="single_product.html">
                                <figure> <img class="first-img" src="static/home/images/products/img03.jpg" alt=""> <img class="hover-img" src="static/home/images/products/img03.jpg" alt=""></figure>
                                </a>
                                <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span>加入购物车</span> </button>
                              </div>
                              <div class="pr-info-area">
                ...
                <div class="product-item">
                  <div class="item-inner">
                    <div class="product-thumbnail">
                      ...
                      <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="single_product.html">
                        <figure> <img class="first-img" src="static/home/images/products/img15.jpg" alt=""> <img class="hover-img" src="static/home/images/products/img15.jpg" alt=""></figure>
                        </a>
                        <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span>加入购物车</span> </button>
                      </div>
              ...
              <div class="product-item">
                <div class="item-inner">
                  <div class="product-thumbnail">
                    ...
                    <div class="icon-new-label new-right">New</div>
                    <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="single_product.html">
                      <figure> <img class="first-img" src="static/home/images/products/img08.jpg" alt=""> <img class="hover-img" src="static/home/images/products/img08.jpg" alt=""></figure>
                      </a>
      ...
      <div class="slider-items-products">
        <div id="latest-news-slider" class="product-flexslider hidden-buttons">
          <div class="slider-items slider-width-col6"> 
            ...
            <div class="item">
              <div class="jtv-blog">
                <div class="blog-img"> <a href="single_post.html"> <img class="primary-img" src="static/home/images/blog-img1.jpg" alt=""></a> <span class="moretag"></span> </div>
