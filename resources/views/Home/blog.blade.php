...
<html lang="en">
 <head> 
  ...
  <!-- style CSS --> 
  <link rel="stylesheet" type="text/css" href="/static/home/css/blog.css" media="all" />   <link rel="stylesheet" type="text/css" href="/static/js/css.css" /> 
 </head> 
      ...
      <a class="news_ck" href="javascript:void(0)">查看详情</a>
        ...
        <div class="headerlinkmenu col-lg-8 col-md-7 col-sm-8 col-xs-12"> 
         <div class="links"> 
          ...
          <div class="blog">
           <a title="Blog" href="/indexBlog"><i class="fa fa-rss"></i><span class="hidden-xs">Blog</span></a>
          </div> 
          <div class="login">
