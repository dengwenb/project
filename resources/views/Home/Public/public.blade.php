...
<link href="/static/Home/HomeLogin/css/default.css" rel="stylesheet"> 
...
<div id="page"> 
  ...
  <header>
    <div class="header-container">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-sm-4 hidden-xs"> 
              ...
              <span class="phone hidden-sm">在线人数：</span> </div>
            
            <!-- top links -->
            <div class="headerlinkmenu col-lg-8 col-md-7 col-sm-8 col-xs-12">
              <div class="links">
                <div class="myaccount"><a title="My Account" href="/userinfo"><i class="fa fa-user"></i><span class="hidden-xs">个人中心</span></a></div>
     ...
     <div class="login">
     @if(session('username'))
     欢迎 <a href="" style="color:red">{{session('username')}}</a><a href="/homelogin">退出</a>
     @else
     <a href="/homelogin"><i class="fa fa-unlock-alt"></i><span class="hidden-xs">登陆</span></a>|<a href="/homelogin"><i class="fa fa-unlock-alt"></i><span class="hidden-xs">注册</span></a>
     @endif
     </div>
              </div>
              <!-- 语言设置 -->
              <div class="language-currency-wrapper">
                <div class="inner-cl">
                  <div class="block block-language form-language">
                    <div class="lg-cur"> <span> <img src="/static/Home/HomeLogin/images/flag-default.jpg" alt="French"> <span class="lg-fr">French</span> <i class="fa fa-angle-down"></i> </span> </div>
                    <ul>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-3 col-md-3 col-xs-12"> 
            <!-- 商城 Logo -->
            <div class="logo"><a title="e-commerce" href="index.html"><img alt="e-commerce" src="/static/Home/HomeLogin/images/logo.png"></a> </div>
            <!-- End Header Logo --> 
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-md-4 col-xs-12 col-lg-3">
          <div class="footer-logo"><a href="index.html"><img src="/static/Home/HomeLogin/images/footer-logo.png" alt="fotter logo"></a> </div>
