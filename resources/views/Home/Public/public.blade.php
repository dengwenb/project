...
<link href="/static/home/css/default.css" rel="stylesheet"> 
        ...
        <div class="col-md-3 col-sm-4">
          ...
          <div class="mega-container visible-lg visible-md visible-sm">
            <div class="navleft-container">
              ...
              <div class="mega-menu-category" @if ($_SERVER['REQUEST_URI'] !=="/home" && $_SERVER['REQUEST_URI'] !=="/"  ) style="display: none;" @endif>
                <ul class="nav">
                <!-- 左侧导航顶级 -->
               @foreach ($nav as $row)
                         ...
                         @foreach($row->suv as $rows) 
                          <div class="col-md-4 col-sm-6">
                            ...
                            <ul class="nav">
                              ...
                              <li><a href="shop_grid.html">>>>{{$rowss->name}}</a></li>
                             @endforeach
                            </ul>
                            <br>
                               @endif
          ...
          <div class="mtmegamenu">
            <ul>
              ...
              <li class="mt-root">
                ...
                <!-- 热销推荐 -->
                  <div class="title title_font"><span class="title-text">{{$_SERVER['REQUEST_URI']}}</span></div>
                </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-2 col-xs-12 col-lg-3 collapsed-block">
          <div class="footer-links">
            <h3 class="links-title">友情链接<a class="expander visible-xs" href="#TabBlock-4">+</a></h3>
