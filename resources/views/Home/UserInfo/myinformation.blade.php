...
@section('content')
  ...
  <div class="user-profile clearfix"> 
   <div class="user-profile-wrap"> 
    <div class="profile-avatar"> 
     <img src="@if($data){{$data->pic}} @else  @endif" /> 
   ...
   <div class="profile-info"> 
    <div class="control-group clearfix "> 
     <div class="controls lh26"> 
      <label class="control-label"><em>*</em><span style="margin-left: 10px;">用户名:</span> <input style="margin-left: 10px;" type="text" class="text" name="user" value="@if($data){{$data->username}}@else  @endif"/>  </label>
     </div> 
  ...
  <div class="form-list tab-switch personal-wrap-show"> 
    ...
    <div class="control-group clearfix"> 
     ...
     <div class="controls"> 
      <input type="text" class="text" maxlength="12" value="@if($data){{$data->name}} @else  @endif" name="username"/> 
     </div> 
    </div> 
    ...
    <div class="control-group clearfix"> 
     ...
     <div id="gender" class="controls"> 
      <label class="sex-label"> <input type="radio" name="sex" value="1"@if($data)@if($data->sex==1)checked @endif @else  @endif/> <span>男</span> </label> 
      <label class="sex-label"> <input type="radio" name="sex" value="2"@if($data)@if($data->sex==2)checked @endif @else  @endif/> <span>女</span> </label> 
      <label class="sex-label"> <input type="radio" name="sex" value="3"@if($data)@if($data->sex==3)checked @endif @else  @endif/> <span>保密</span> </label> 
     </div> 
    </div> 
  	<div class="control-group clearfix"> 
     ...
     <div class="controls"> 
      <input  type="text" class="text" maxlength="20" name="phone" value="@if($data){{$data->phone}}@else  @endif"/> 
     </div> 
	...
	<div class="control-group clearfix"> 
     ...
     <input type="hidden" name="userid" value="@if($data){{$data->userid}} @else @endif">
     <div class="controls"> 
      <input id="" type="text" class="text" maxlength="20" name="email" value="@if($data) {{$data->email}} @else  @endif"/> 
     </div> 
     <div id="" class="error-place"> 
     </div> 
    </div> 
    ...
    <div class="control-group clearfix priority-high box" style="display:none;"> 
     ...
     <div class="controls"> 
  	...
  	<div class="control-group clearfix boxx" > 
     <label class="control-label">居住地址：</label> 
     <div class="controls"> 
      <input id="" type="text" class="text" maxlength="20" name="city" value="@if($data) {{$data->address}} @else  @endif" style="width:200px;"/> <a href="javascript:void(0)" style="color:red;" id="xiu">修改</a>
     </div> 
     <div id="" class="error-place"> 
     </div> 
    </div> 
