...
<html lang="en">
 <head> 
  ...
  <link rel="stylesheet" type="text/css" href="/static/Home/Homelogin/css/owl.transitions.css" /> 
  <!-- animate CSS  --> 
  <link rel="stylesheet" type="text/css" href="/static/Home/Homelogin/css/animate.css" media="all" /> 
  <!-- flexslider CSS --> 
  <link rel="stylesheet" type="text/css" href="/static/Home/Homelogin/css/flexslider.css" /> 
  <!-- jquery-ui.min CSS  --> 
  <link rel="stylesheet" type="text/css" href="/static/Home/Homelogin/css/jquery-ui.css" /> 
  <!-- Revolution Slider CSS --> 
  <link href="/static/Home/Homelogin/css/revolution-slider.css" rel="stylesheet" /> 
  <!-- style CSS --> 
 ...
 <body class="cms-index-index cms-home-page"> 
         ...
         <div class="language-currency-wrapper"> 
          <div class="inner-cl"> 
           <div class="block block-language form-language"> 
            <div class="lg-cur"> 
             <span> <img src="/static/Home/Homelogin/images/flag-default.jpg" alt="French" /> <span class="lg-fr">French</span> <i class="fa fa-angle-down"></i> </span> 
            </div> 
            <ul> 
             <li> <a class="selected" href="#"> <img src="/static/Home/Homelogin/images/flag-english.jpg" alt="flag" /> <span>English</span> </a> </li> 
             <li> <a href="#"> <img src="/static/Home/Homelogin/images/flag-default.jpg" alt="flag" /> <span>French</span> </a> </li> 
             <li> <a href="#"> <img src="/static/Home/Homelogin/images/flag-german.jpg" alt="flag" /> <span>German</span> </a> </li> 
             <li> <a href="#"> <img src="/static/Home/Homelogin/images/flag-brazil.jpg" alt="flag" /> <span>Brazil</span> </a> </li> 
             <li> <a href="#"> <img src="/static/Home/Homelogin/images/flag-chile.jpg" alt="flag" /> <span>Chile</span> </a> </li> 
             <li> <a href="#"> <img src="/static/Home/Homelogin/images/flag-spain.jpg" alt="flag" /> <span>Spain</span> </a> </li> 
            </ul> 
           </div> 
     ...
     <div class="container"> 
      <div class="row"> 
       <div class="col-sm-3 col-md-3 col-xs-12"> 
        <!-- Header Logo --> 
        <div class="logo">
         <a title="e-commerce" href="index.html"><img alt="e-commerce" src="/static/Home/Homelogin/images/logo.png" /></a> 
        </div> 
        <!-- End Header Logo --> 
       </div> 
          ...
          <div> 
           <div class="top-cart-content"> 
            ...
            <ul id="cart-sidebar" class="mini-products-list"> 
             <li class="item odd"> <a href="shopping_cart.html" title="Ipsums Dolors Untra" class="product-image"><img src="/static/Home/Homelogin/images/products/img07.jpg" alt="Lorem ipsum dolor" width="65" /></a> 
             ...
             <li class="item even"> <a href="shopping_cart.html" title="Ipsums Dolors Untra" class="product-image"><img src="/static/Home/Homelogin/images/products/img11.jpg" alt="Lorem ipsum dolor" width="65" /></a> 
              <div class="product-details"> 
               <a href="#" title="Remove This Item" class="remove-cart"><i class="icon-close"></i></a> 
             ...
             <li class="item last odd"> <a href="shopping_cart.html" title="Ipsums Dolors Untra" class="product-image"><img src="/static/Home/Homelogin/images/products/img10.jpg" alt="Lorem ipsum dolor" width="65" /></a> 
              <div class="product-details"> 
               <a href="#" title="Remove This Item" class="remove-cart"><i class="icon-close"></i></a> 
               ...
               <div class="col-md-4 has-sep hidden-sm"> 
                <div class="custom-menu-right"> 
                 <div class="box-banner menu-banner"> 
                  <div class="add-right">
                   <a href="#"><img src="/static/Home/Homelogin/images/menu-img4.jpg" alt="" /></a>
                  </div> 
                 </div> 
                </div> 
               </div> 
               ...
               <div class="col-md-4 has-sep hidden-sm"> 
                <div class="custom-menu-right"> 
                 <div class="box-banner media"> 
                  ...
                  <div class="add-right">
                   <a href="#"><img src="/static/Home/Homelogin/images/menu-img1.jpg" alt="" /></a>
                  </div> 
                 </div> 
                 <div class="box-banner media"> 
                  <div class="add-desc"> 
                  ...
                  <div class="add-right">
                   <a href="#"><img src="/static/Home/Homelogin/images/menu-img2.jpg" alt="" /></a>
                  </div> 
                 </div> 
                </div> 
               </div> 
            ...
            <div class="wrap-popup column2"> 
             <div class="popup"> 
              <div class="row"> 
               ...
               <div class="col-sm-12"> 
                <a class="ads1" href="#"><img class="img-responsive" src="/static/Home/Homelogin/images/menu-img3.jpg" alt="" /></a> 
               </div> 
              </div> 
             </div> 
            </div> </li> 
              ...
              <div class="product-thumbnail"> 
               ...
               <div class="pr-img-area"> 
                <a title="Ipsums Dolors Untra" href="single_product.html"> 
                 <figure> 
                  <img class="first-img" src="/static/Home/Homelogin/images/products/img06.jpg" alt="" /> 
                  <img class="hover-img" src="/static/Home/Homelogin/images/products/img06.jpg" alt="" />
                 </figure> </a> 
             ...
             <div class="item-inner"> 
              <div class="product-thumbnail"> 
               ...
               <div class="pr-img-area"> 
                <a title="Ipsums Dolors Untra" href="single_product.html"> 
                 <figure> 
                  <img class="first-img" src="/static/Home/Homelogin/images/products/img02.jpg" alt="" /> 
                  <img class="hover-img" src="/static/Home/Homelogin/images/products/img02.jpg" alt="" />
                 </figure> </a> 
                <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button> 
               </div> 
               <div class="pr-info-area"> 
             ...
             <div class="item-inner"> 
              ...
              <div class="product-thumbnail"> 
               ...
               <div class="pr-img-area"> 
                <a title="Ipsums Dolors Untra" href="single_product.html"> 
                 <figure> 
                  <img class="first-img" src="/static/Home/Homelogin/images/products/img03.jpg" alt="" /> 
                  <img class="hover-img" src="/static/Home/Homelogin/images/products/img03.jpg" alt="" />
                 </figure> </a> 
                <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button> 
               </div> 
               <div class="pr-info-area"> 
     ...
     <div class="tp-banner"> 
      <ul> 
       ...
       <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700"> 
        <!-- MAIN IMAGE --> <img src="/static/Home/Homelogin/images/slider/slider-img1.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat" /> 
        <!-- LAYERS --> 
        <!-- LAYER NR. 1 --> 
       ...
       <!-- SLIDE 2 --> 
       <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700"> 
        <!-- MAIN IMAGE --> <img src="/static/Home/Homelogin/images/slider/slider-img2.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat" /> 
        <!-- LAYERS --> 
        <!-- LAYER NR. 1 --> 
       ...
       <!-- SLIDE 3 --> 
       <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700"> 
        <!-- MAIN IMAGE --> <img src="/static/Home/Homelogin/images/slider/slider-img3.jpg" alt="slidebg3" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat" /> 
        <!-- LAYERS --> 
        <!-- LAYER NR. 1 --> 
               ...
               <div class="item-inner"> 
                <div class="product-thumbnail"> 
                 ...
                 <div class="pr-img-area"> 
                  <a title="Ipsums Dolors Untra" href="single_product.html"> 
                   <figure> 
                    <img class="first-img" src="/static/Home/Homelogin/images/products/img01.jpg" alt="" /> 
                    <img class="hover-img" src="/static/Home/Homelogin/images/products/img01.jpg" alt="" />
                   </figure> </a> 
                  <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button> 
                 </div> 
                 <div class="pr-info-area"> 
               ...
               <div class="item-inner"> 
                ...
                <div class="product-thumbnail"> 
                 <div class="pr-img-area"> 
                  <a title="Ipsums Dolors Untra" href="single_product.html"> 
                   <figure> 
                    <img class="first-img" src="/static/Home/Homelogin/images/products/img04.jpg" alt="" /> 
                    <img class="hover-img" src="/static/Home/Homelogin/images/products/img04.jpg" alt="" />
                   </figure> </a> 
                  <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button> 
                 </div> 
                 <div class="pr-info-area"> 
               ...
               <div class="item-inner"> 
                <div class="product-thumbnail"> 
                 ...
                 <div class="pr-img-area"> 
                  <a title="Ipsums Dolors Untra" href="single_product.html"> 
                   <figure> 
                    <img class="first-img" src="/static/Home/Homelogin/images/products/img05.jpg" alt="" /> 
                    <img class="hover-img" src="/static/Home/Homelogin/images/products/img05.jpg" alt="" />
                   </figure> </a> 
                  <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button> 
                 </div> 
                 <div class="pr-info-area"> 
               ...
               <div class="item-inner"> 
                <div class="product-thumbnail"> 
                 ...
                 <div class="pr-img-area"> 
                  <a title="Ipsums Dolors Untra" href="single_product.html"> 
                   <figure> 
                    <img class="first-img" src="/static/Home/Homelogin/images/products/img08.jpg" alt="" /> 
                    <img class="hover-img" src="/static/Home/Homelogin/images/products/img08.jpg" alt="" />
                   </figure> </a> 
                  <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button> 
                 </div> 
                 <div class="pr-info-area"> 
           ...
           <div class="item-inner"> 
            <div class="product-thumbnail"> 
             ...
             <div class="pr-img-area"> 
              <a title="Ipsums Dolors Untra" href="single_product.html"> 
               <figure> 
                <img class="first-img" src="/static/Home/Homelogin/images/products/img15.jpg" alt="" /> 
                <img class="hover-img" src="/static/Home/Homelogin/images/products/img15.jpg" alt="" />
               </figure> </a> 
              <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button> 
             </div> 
    ...
    <div class="row"> 
     <div class="col-sm-4 col-xs-12"> 
      <div class="jtv-banner-box banner-inner"> 
       <div class="image"> 
        <a class="jtv-banner-opacity" href="#"><img src="/static/Home/Homelogin/images/top-banner1.jpg" alt="" /></a> 
       </div> 
     ...
     <div class="col-sm-5 col-xs-12"> 
      <div class="jtv-banner-box"> 
       <div class="image"> 
        <a class="jtv-banner-opacity" href="#"><img src="/static/Home/Homelogin/images/top-banner2.jpg" alt="" /></a> 
       </div> 
       <div class="jtv-content-text"> 
     ...
     <div class="col-sm-3 col-xs-12"> 
      <div class="jtv-banner-box banner-inner"> 
       <div class="image"> 
        <a class="jtv-banner-opacity" href="#"><img src="/static/Home/Homelogin/images/top-banner3.jpg" alt="" /></a> 
       </div> 
       <div class="jtv-content-text"> 
      ...
      <div class="jtv-banner-box banner-inner"> 
       <div class="image "> 
        <a class="jtv-banner-opacity" href="#"><img src="/static/Home/Homelogin/images/top-banner4.jpg" alt="" /></a> 
       </div> 
       <div class="jtv-content-text"> 
          ...
          <div class="item-inner"> 
           <div class="product-thumbnail"> 
            <div class="pr-img-area"> 
             <a title="Ipsums Dolors Untra" href="single_product.html"> 
              <figure> 
               <img class="first-img" src="/static/Home/Homelogin/images/products/img13.jpg" alt="" /> 
               <img class="hover-img" src="/static/Home/Homelogin/images/products/img13.jpg" alt="" />
              </figure> </a> 
             <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button> 
            </div> 
            <div class="pr-info-area"> 
          ...
          <div class="item-inner"> 
           <div class="product-thumbnail"> 
            <div class="pr-img-area"> 
             <a title="Ipsums Dolors Untra" href="single_product.html"> 
              <figure> 
               <img class="first-img" src="/static/Home/Homelogin/images/products/img09.jpg" alt="" /> 
               <img class="hover-img" src="/static/Home/Homelogin/images/products/img09.jpg" alt="" />
              </figure> </a> 
             <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button> 
            </div> 
            <div class="pr-info-area"> 
          ...
          <div class="item-inner"> 
           ...
           <div class="product-thumbnail"> 
            <div class="pr-img-area"> 
             <a title="Ipsums Dolors Untra" href="single_product.html"> 
              <figure> 
               <img class="first-img" src="/static/Home/Homelogin/images/products/img12.jpg" alt="" /> 
               <img class="hover-img" src="/static/Home/Homelogin/images/products/img12.jpg" alt="" />
              </figure> </a> 
             <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button> 
            </div> 
            <div class="pr-info-area"> 
        ...
        <div id="testimonials-slider" class="product-flexslider hidden-buttons home-testimonials"> 
         <div class="slider-items slider-width-col4 "> 
          <div class="holder"> 
           ...
           <div class="thumb"> 
            <img src="/static/Home/Homelogin/images/testimonials-img3.jpg" alt="testimonials img" /> 
           </div> 
          ...
          <div class="holder"> 
           ...
           <div class="thumb"> 
            <img src="/static/Home/Homelogin/images/testimonials-img1.jpg" alt="testimonials img" /> 
           </div> 
          ...
          <div class="holder"> 
           ...
           <div class="thumb"> 
            <img src="/static/Home/Homelogin/images/testimonials-img2.jpg" alt="testimonials img" /> 
           </div> 
           <strong class="name">John Doe</strong> 
          ...
          <div class="holder"> 
           <p>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p> 
           <div class="thumb"> 
            <img src="/static/Home/Homelogin/images/testimonials-img4.jpg" alt="testimonials img" /> 
           </div> 
           <strong class="name">Vince Roy</strong> 
       ...
       <div class="slider-items-products"> 
        <div id="our-clients-slider" class="product-flexslider hidden-buttons"> 
         <div class="slider-items slider-width-col6"> 
          <!-- Item --> 
          <div class="item"> 
           <a href="#"><img src="/static/Home/Homelogin/images/brand1.png" alt="Image" /></a> 
           <a href="#"><img src="/static/Home/Homelogin/images/brand2.png" alt="Image" /></a> 
          </div> 
          <!-- End Item --> 
          <!-- Item --> 
          <div class="item"> 
           <a href="#"><img src="/static/Home/Homelogin/images/brand3.png" alt="Image" /></a> 
           <a href="#"><img src="/static/Home/Homelogin/images/brand4.png" alt="Image" /></a> 
          </div> 
          <!-- End Item --> 
          <!-- Item --> 
          <div class="item"> 
           <a href="#"><img src="/static/Home/Homelogin/images/brand5.png" alt="Image" /></a> 
           <a href="#"><img src="/static/Home/Homelogin/images/brand6.png" alt="Image" /></a> 
          </div> 
          <!-- End Item --> 
          <!-- Item --> 
          <div class="item"> 
           <a href="#"><img src="/static/Home/Homelogin/images/brand7.png" alt="Image" /></a> 
           <a href="#"><img src="/static/Home/Homelogin/images/brand3.png" alt="Image" /></a> 
          </div> 
          <!-- End Item --> 
         </div> 
      ...
      <div id="latest-news-slider" class="product-flexslider hidden-buttons"> 
       <div class="slider-items slider-width-col6"> 
        ...
        <div class="item"> 
         <div class="jtv-blog"> 
          <div class="blog-img"> 
           <a href="single_post.html"> <img class="primary-img" src="/static/Home/Homelogin/images/blog-img1.jpg" alt="" /></a> 
        ...
        <div class="item"> 
         <div class="jtv-blog"> 
          <div class="blog-img"> 
           <a href="single_post.html"><img class="primary-img" src="/static/Home/Homelogin/images/blog-img2.jpg" alt="" /></a> 
          </div> 
          <div class="blog-content-jtv"> 
        ...
        <div class="item"> 
         <div class="jtv-blog"> 
          <div class="blog-img"> 
           <a href="single_post.html"><img class="primary-img" src="/static/Home/Homelogin/images/blog-img3.jpg" alt="" /></a> 
          </div> 
          <div class="blog-content-jtv"> 
    ...
    <div class="container"> 
     <div class="row"> 
      <div class="col-md-4 col-sm-4"> 
       <a href="#" class="bottom-banner-img"><img src="/static/Home/Homelogin/images/ads-04.jpg" alt="bottom banner" /> <span class="banner-overly"></span> 
      ...
      <div class="col-md-8 col-sm-8"> 
       <a href="#" class="bottom-banner-img last"><img src="/static/Home/Homelogin/images/ads-05.jpg" alt="bottom banner" /> <span class="banner-overly last"></span> 
     ...
     <div class="row"> 
       ...
       <div class="jtv-single-cat"> 
        ...
        <div class="jtv-product"> 
         <div class="product-img"> 
          <a href="single_product.html"> <img src="/static/Home/Homelogin/images/products/img10.jpg" alt="" /> <img class="secondary-img" src="/static/Home/Homelogin/images/products/img10.jpg" alt="" /> </a> 
         </div> 
        ...
        <div class="jtv-product jtv-cat-margin"> 
         <div class="product-img"> 
          <a href="single_product.html"> <img src="/static/Home/Homelogin/images/products/img07.jpg" alt="" /> <img class="secondary-img" src="/static/Home/Homelogin/images/products/img08.jpg" alt="" /> </a> 
         </div> 
         <div class="jtv-product-content"> 
          <h3><a href="single_product.html">Lorem ipsum dolor sit amet</a></h3> 
          <div class="price-box"> 
        ...
        <div class="jtv-product jtv-cat-margin"> 
         <div class="product-img"> 
          <a href="single_product.html"> <img src="/static/Home/Homelogin/images/products/img08.jpg" alt="" /> <img class="secondary-img" src="/static/Home/Homelogin/images/products/img09.jpg" alt="" /> </a> 
         </div> 
         <div class="jtv-product-content"> 
          <h3><a href="single_product.html">Lorem ipsum dolor sit amet</a></h3> 
          <div class="price-box"> 
      ...
      <div class="col-md-4 col-sm-6"> 
       <div class="jtv-single-cat"> 
        ...
        <div class="jtv-product"> 
         <div class="product-img"> 
          <a href="single_product.html"> <img src="/static/Home/Homelogin/images/products/img12.jpg" alt="" /> <img class="secondary-img" src="/static/Home/Homelogin/images/products/img11.jpg" alt="" /> </a> 
         </div> 
         <div class="jtv-product-content"> 
          <h3><a href="single_product.html">Lorem ipsum dolor sit amet</a></h3> 
          <div class="price-box"> 
        ...
        <div class="jtv-product jtv-cat-margin"> 
         <div class="product-img"> 
          <a href="single_product.html"> <img src="/static/Home/Homelogin/images/products/img05.jpg" alt="" /> <img class="secondary-img" src="/static/Home/Homelogin/images/products/img10.jpg" alt="" /> </a> 
         </div> 
         <div class="jtv-product-content"> 
          <h3><a href="single_product.html">Lorem ipsum dolor sit amet</a></h3> 
          <div class="price-box"> 
        ...
        <div class="jtv-product jtv-cat-margin"> 
         <div class="product-img"> 
          <a href="single_product.html"> <img src="/static/Home/Homelogin/images/products/img01.jpg" alt="" /> <img class="secondary-img" src="/static/Home/Homelogin/images/products/img03.jpg" alt="" /> </a> 
         </div> 
         <div class="jtv-product-content"> 
          <h3><a href="single_product.html">Lorem ipsum dolor sit amet</a></h3> 
          <div class="price-box"> 
       ...
       <div class="jtv-service-area"> 
        ...
        <div class="jtv-single-service"> 
         <div class="service-icon"> 
          <img alt="" src="/static/Home/Homelogin/images/customer-service-icon.png" /> 
         </div> 
        ...
        <div class="jtv-single-service"> 
         <div class="service-icon"> 
          <img alt="" src="/static/Home/Homelogin/images/shipping-icon.png" /> 
         </div> 
         <div class="service-text"> 
        ...
        <div class="jtv-single-service"> 
         <div class="service-icon"> 
          <img alt="" src="/static/Home/Homelogin/images/guaratee-icon.png" /> 
         </div> 
         <div class="service-text"> 
     ...
     <div class="row"> 
      <div class="col-sm-6 col-md-4 col-xs-12 col-lg-3"> 
       <div class="footer-logo">
        <a href="index.html"><img src="/static/Home/Homelogin/images/footer-logo.png" alt="fotter logo" /></a> 
       </div> 
     ...
     <div class="container"> 
      <div class="row"> 
       ...
       <div class="col-sm-6 col-xs-12"> 
        <div class="payment"> 
         <ul> 
          <li><a href="#"><img title="Visa" alt="Visa" src="/static/Home/Homelogin/images/visa.png" /></a></li> 
          <li><a href="#"><img title="Paypal" alt="Paypal" src="/static/Home/Homelogin/images/paypal.png" /></a></li> 
          <li><a href="#"><img title="Discover" alt="Discover" src="/static/Home/Homelogin/images/discover.png" /></a></li> 
          <li><a href="#"><img title="Master Card" alt="Master Card" src="/static/Home/Homelogin/images/master-card.png" /></a></li> 
         </ul> 
        </div> 
       </div> 
      </div> 
  ...
  <!-- JS --> 
  <!-- jquery js --> 
  <script type="text/javascript" src="/static/Home/Homelogin/js/jquery.min.js"></script> 
  <!-- bootstrap js --> 
  <script type="text/javascript" src="/static/Home/Homelogin/js/bootstrap.min.js"></script> 
  <!-- owl.carousel.min js --> 
  <script type="text/javascript" src="/static/Home/Homelogin/js/owl.carousel.min.js"></script> 
  <!-- bxslider js --> 
  <script type="text/javascript" src="/static/Home/Homelogin/js/jquery.bxslider.js"></script> 
  <!-- Slider Js --> 
  <script type="text/javascript" src="/static/Home/Homelogin/js/revolution-slider.js"></script> 
  <!-- megamenu js --> 
  <script type="text/javascript" src="/static/Home/Homelogin/js/megamenu.js"></script> 
  ...
  <script type="text/javascript" src="/static/Home/Homelogin/js/mobile-menu.js"></script> 
  <!--jquery-ui.min js --> 
  <script type="text/javascript" src="/static/Home/Homelogin/js/jquery-ui.js"></script> 
  <!-- main js --> 
  <script type="text/javascript" src="/static/Home/Homelogin/js/main.js"></script> 
  <!-- countdown js --> 
  <script type="text/javascript" src="/static/Home/Homelogin/js/countdown.js"></script> 
  <!-- Revolution Slider --> 
  <script type="text/javascript">
