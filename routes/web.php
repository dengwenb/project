...
//支付成功
Route::get('/cg','Home\PayController@cg');
//优惠券首页
...
//我的订单
Route::get('/myorder','Home\UserInfoController@myorder');
//我的订单详情
Route::resource('/myorderinfo','Home\UserInfoController');
//订单取消
Route::get('/myorderqx','Home\UserInfoController@qx');
