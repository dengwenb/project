<?php 
	...
	$options['accountsid']='d94fb24f5ba20494a6dc9ca88b82835a';
	//填写在开发者控制台首页上的Auth Token
	$options['token']='642c2687afde583b221641bd315e850a';
	//初始化 $options必填
	$ucpass = new Ucpaas($options);
	// var_dump($ucpass);exit;
	$appid = "4696ac2ac0dc4969952d9bace207867b"; //应用的ID，可在开发者控制台内的短信产品下查看
	$templateid = "387313"; //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
	$param = 1234; //多个参数使用英文逗号隔开（如：param=“a,b,c”），如为参数则留空
	\Cookie::queue('code',$param,1);
	$mobile =$p;
	$uid = "";
