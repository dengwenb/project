...
<style>
   #dis{position:relative;left:375px;top:45px;z-index:999;} 
                ...
                <div class="box-bd" >
                    <ul id="checkoutShipmentList" class="checkout-option-list clearfix J_optionList">
                     @foreach ($wl as $key=>$value)
                                                <li class="item @if($key==0) selected @endif" onclick="func(this)">
                            <input type="radio" data-price="0" name="postage"  @if($key==0) checked @endif value="{{$value->postage}}">
                            <p>
                                {{$value->name}}                               <span> 运费：<font >{{$value->postage}}</font></span>
                            </p>
                        </li>
                         @endforeach
                                            </ul>
                        ...
                        <div class="checkout-count clearfix">
                            ...
                            <div class="checkout-price">
                                <ul>
                                    ...
                                    <li>
                                        优惠券抵扣：<span id="couponDesc"><font class="font1">优惠券不可用</font></span>
                                    </li>
                                    <li>
                                ...
                                <p class="checkout-total">应付总额：<span><strong id="totalPrice" class="total">{{$total}}</strong>元</span></p>
                                <span></span>
                            </div>
                            <!--  -->
                        </div>
...
<script>
  ...
  function func1 (obj,pri,id){
    ...
    function func (obj){
          ...
          a=$(obj).children('p').children('span').children('font').html();
          Number(a);
          $('.font2').html(a);
          b=Number(t)+Number(a);
           b=b.toFixed(2);
